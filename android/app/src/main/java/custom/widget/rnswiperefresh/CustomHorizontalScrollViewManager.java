 ...
 */
@ReactModule(name = CustomHorizontalScrollViewManager.REACT_CLASS)
public class CustomHorizontalScrollViewManager
  ...
  public static final String REACT_CLASS = "AndroidCustomHorizontalScrollView";
  ...
  public CustomHorizontalScrollViewManager() {
    this(null);
  }

  public CustomHorizontalScrollViewManager(@Nullable FpsListener fpsListener) {
