...
public class CustomScrollViewManager
  ...
  public CustomScrollViewManager() {
    this(null);
  }

  public CustomScrollViewManager(@Nullable FpsListener fpsListener) {
